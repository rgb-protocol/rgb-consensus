...
mod test {
    ...
    use crate::commit_verify::ConvolveVerifyError;
    use crate::dbc::tapret::TapretPathProof;

    #[test]
    fn no_commitment() {
        let hex = "";
        let bytes = Vec::<u8>::from_hex(hex).unwrap();
        let tx: Tx = consensus::deserialize(&bytes).unwrap();

        let internal_pk: UntweakedPublicKey = unsafe {
